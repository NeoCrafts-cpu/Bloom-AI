...
const PHASES = [
  ...
  },
  {
    ...
    status: "active",
    items: [
      "SoDEX WebSocket relay — live order fills streamed to frontend",
      "Portfolio analytics dashboard with live P&L tracking",
      "StrategiesGrid live prices — replace static currentPrice with SoDEX feed",
      "Subscriber leaderboard and social copy-trade profiles",
      "Institutional API access tier for hedge funds",
    ],
  },
  {
    phase: "Phase 3",
